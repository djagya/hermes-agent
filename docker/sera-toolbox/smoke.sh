...
if ! grep -q 'snapshot.debian.org/archive/debian/20260914T000000Z' \
      /etc/apt/sources.list.d/debian.sources ||
   ! grep -q 'snapshot.debian.org/archive/debian-security/20260914T000000Z' \
      /etc/apt/sources.list.d/debian.sources ||
   ! grep -q 'trixie-security' /etc/apt/sources.list.d/debian.sources; then
  echo "apt sources missing Debian snapshot 20260914T000000Z main/updates/security" >&2
  fail=1
fi
