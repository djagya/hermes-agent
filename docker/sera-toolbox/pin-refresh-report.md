...
|---|---|---|---|
| debian:13.4 | `` | `sha256:e2d08da6f42ef4b09b165d55528a12727aeed8240dc9edf888e3ec07e10ef9da` | bump [release](https://hub.docker.com/_/debian) |
| node:26-bookworm-slim | `sha256:9e6f9357d371591e32ab6f2d8a26d63bdd0d17c29eee3f4f3e7e454d9634bf73` | `sha256:582460f614631b59b824ac6020533b9bf339c7fdf3a6d7db31abb6b4065f0212` | bump [release](https://hub.docker.com/_/node) |
| s6-overlay | `3.2.3.0` | `3.2.3.2` | bump [release](https://github.com/just-containers/s6-overlay/releases/tag/v3.2.3.2) |
| gh | `2.100.0` | `2.101.0` | bump [release](https://github.com/cli/cli/releases/tag/v2.101.0) |
...
| uv image | `0.11.6-python3.13-trixie@sha256:b3c543b6c4f23a5f2df22866bd7857e5d304b67a564f4feab6ac22044dde719b` | `0.12.17-python3.13-trixie@sha256:b49f54e077b975791900368b1c51f8ce2e139f0eba89d4a2dc0cad6d614d8736` | bump [release](https://github.com/astral-sh/uv/releases/tag/0.12.17) |
| sqlite-autoconf | `3530400` | `3530400` | same [release](https://sqlite.org/download.html) |
| DEBIAN_SNAPSHOT | `20260914T000000Z` | `20260914T000000Z` | same [release](https://snapshot.debian.org/) |
...
- gh 2.100.0 -> 2.101.0
- tirith 0.3.3 -> 0.4.2
- uv 0.11.6-python3.13-trixie -> 0.12.17-python3.13-trixie
