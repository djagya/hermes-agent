...
from tools.terminal_tool_guards import (
    ...
    gateway_lifecycle_block, live_gateway_test_block, self_repo_block,
)
...
def _pre_exec_block(
    ...
    then the live-gateway Hermes-test block (the 2026-09-17 suite-SIGTERM
    incident), then the dangerous-workdir check, then the self-repo guard
    (local only).
    """
